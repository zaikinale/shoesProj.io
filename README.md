![CI Status](https://github.com/zaikinale/shoesProj.io/actions/workflows/ci.yml/badge.svg)

# ShoesProj — интернет-магазин и лояльность
...
```env
DATABASE_URL="postgresql://shoes:shoes@localhost:5432/shoesdb"
```
...
См. `package.json` в подпроектах (по умолчанию backend: ISC).
