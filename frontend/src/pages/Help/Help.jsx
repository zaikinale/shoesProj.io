...
export default function Help() {
    ...
    const handleCreateTicket = async (e) => {
        ...
        try {
            ...
            if (formData.firstMessage) {
                await sendMessage(ticket.id, { text: formData.firstMessage, image: formData.image });
            }
        ...
        <div className={styles.page}>
            <header className={styles.header}>
                ...
                <div className={styles.nav}>
                    ...
                    <NavigateTo path="profile" />
                    {!isStaff && (
                        <button className={styles.btnNew} onClick={() => {setIsFormOpen(!isFormOpen); setSelectedTicket(null);}}>
                                ...
                                <div className={styles.inputSection}>
                                    ...
                                    <div className={styles.inputBottom}>
                                        <input 
                                            ...
                                            onChange={e => setNewMessage({...newMessage, image: e.target.value})}
                                        />
                                        <button onClick={handleSendMessage} className={styles.btnSend}>Отправить</button>
                                    </div>
                                </div>
                            </div>
                        ) : (
